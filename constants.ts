...
export const AURA_COMMANDS: Record<Language, { emergencyCommands: string[] }> = {
  [Language.EN]: {
    emergencyCommands: ['on sos', 'emergency'],
  },
  [Language.FR]: {
    emergencyCommands: ['sos', 'urgence'],
  },
  [Language.TA]: {
    emergencyCommands: ['எஸ்ஓஎஸ்', 'அவசரம்'],
  },
};